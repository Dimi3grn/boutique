document.addEventListener('DOMContentLoaded', function() {
    ...
    // Vérifier si l'élément existe avant d'ajouter des écouteurs d'événements
    ...
    // Cette page peut être incluse dans d'autres pages qui n'ont pas ces éléments
    
    // Ne procédez qu'avec la page de catalogue qui contient ces éléments
    if (productsContainer && categoryFiltersContainer && colorFiltersContainer) {
        let allWatches = [];
        let categories = [];
        let colors = [];
        let currentFilters = {
        ...
        // Mettre à jour l'affichage du prix si l'élément existe
        ...
        // Appliquer les filtres si le bouton existe
        if (applyFiltersBtn) {
        ...
        // Chargement initial des données si on est sur la page catalogue
